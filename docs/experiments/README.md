...
| 主题 | 记录 |
|---|---|
| v1 长时间随机基线、回归与重放 | `v1-random-baseline-20260723.md` |
| 三类人工缺陷检测、回放与最小化 | `artificial-mutant-detection-20260724.md` |

## Pre-v1 实验

以下记录保存正式 v1 之前的验证结论，只用于说明设计依据，不代表当前可恢复的 artifact
