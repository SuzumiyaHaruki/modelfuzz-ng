...
namespace Microsoft.Coyote.Actors
{
    ...
    public abstract class Actor
    {
        ...
        /// Last sent event.
        /// </summary>
        internal (Event e, ActorId target) LastSendEvent;

        /// <summary>
        /// Scheduled Receive event.
        /// </summary>
        internal (string name, Event e, ActorId origin) ScheduledReceiveEvent;
        ...
        /// </summary>
        internal readonly Dictionary<Type, CachedDelegate> ActionMap;
        ...
        protected Actor()
        {
            ...
            this.LastSendEvent = (null, null);
            this.ScheduledReceiveEvent = (null, null, null);
        }
